...
var Note = _require('./lib/note');
var Interval = _require('./lib/interval');
var Chord = _require('./lib/chord');
var Scale = _require('./lib/scale');
...
_require('./lib/sugar')(teoria);
exports = module.exports = teoria;

},{"./lib/chord":2,"./lib/interval":3,"./lib/note":5,"./lib/scale":6,"./lib/sugar":7}],2:[function(_require,module,exports){
var daccord = _require('daccord');
var knowledge = _require('./knowledge');
var Note = _require('./note');
...
},{"./interval":3,"./knowledge":4,"./note":5,"daccord":9}],3:[function(_require,module,exports){
var knowledge = _require('./knowledge');
var vector = _require('./vector');
var toCoord = _require('interval-coords');
...
},{"./knowledge":4,"./vector":8,"interval-coords":13}],4:[function(_require,module,exports){
...
var scientific = _require('scientific-notation');
var helmholtz = _require('helmholtz');
var pitchFq = _require('pitch-fq');
var knowledge = _require('./knowledge');
var vector = _require('./vector');
var Interval = _require('./interval');
...
},{"./interval":3,"./knowledge":4,"./vector":8,"helmholtz":10,"pitch-fq":14,"scientific-notation":15}],6:[function(_require,module,exports){
var knowledge = _require('./knowledge');
var Interval = _require('./interval');
...
},{"./interval":3,"./knowledge":4}],7:[function(_require,module,exports){
var knowledge = _require('./knowledge');
...
},{"./knowledge":4}],8:[function(_require,module,exports){
module.exports = {
...
var coords = _require('notecoord');
var accval = _require('accidental-value');
...
},{"accidental-value":11,"notecoord":12}],11:[function(_require,module,exports){
...
},{"accidental-value":16,"notecoord":17}],16:[function(_require,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11}],17:[function(_require,module,exports){
